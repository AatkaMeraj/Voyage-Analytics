...
***REMOVED******REMOVED******REMOVED******REMOVED***warnings.filterwarnings("ignore")
...
***REMOVED******REMOVED******REMOVED******REMOVED***y_pred***REMOVED***=***REMOVED***model.predict(X_test)

***REMOVED******REMOVED******REMOVED******REMOVED***#***REMOVED***Evaluate***REMOVED***metrics
***REMOVED******REMOVED******REMOVED******REMOVED***rmse,***REMOVED***mae,***REMOVED***r2***REMOVED***=***REMOVED***eval_metrics(y_test,***REMOVED***y_pred)

***REMOVED******REMOVED******REMOVED******REMOVED***print(f"RMSE:***REMOVED***{rmse}")
***REMOVED******REMOVED******REMOVED******REMOVED***print(f"MAE:***REMOVED***{mae}")
***REMOVED******REMOVED******REMOVED******REMOVED***print(f"R2:***REMOVED***{r2}")

***REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED******REMOVED***#***REMOVED***Log***REMOVED***with***REMOVED***MLflow
***REMOVED******REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED******REMOVED***with***REMOVED***mlflow.start_run():
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mlflow.log_param("model_type",***REMOVED***"RandomForestRegressor_Pipeline")
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mlflow.log_param("train_rows",***REMOVED***X_train.shape[0])
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mlflow.log_param("test_rows",***REMOVED***X_test.shape[0])
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mlflow.log_metric("rmse",***REMOVED***rmse)
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mlflow.log_metric("mae",***REMOVED***mae)
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mlflow.log_metric("r2",***REMOVED***r2)

***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***#***REMOVED***Log***REMOVED***the***REMOVED***pipeline***REMOVED***itself
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***#mlflow.sklearn.log_model(model,***REMOVED***"model")

***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***#***REMOVED***Set***REMOVED***remote***REMOVED***tracking***REMOVED***for***REMOVED***Dagshub
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***remote_server_uri***REMOVED***=***REMOVED***"https://dagshub.com/aatkameraj1425/MLFlow_Voyage_Analytics.mlflow"
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mlflow.set_tracking_uri(remote_server_uri)

***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***#***REMOVED***log***REMOVED***the***REMOVED***model

***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***tracking_url_type_store***REMOVED***=***REMOVED***urlparse(mlflow.get_tracking_uri()).scheme
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***if***REMOVED***tracking_url_type_store***REMOVED***!=***REMOVED***"file":
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mlflow.sklearn.log_model(model,***REMOVED***"model",***REMOVED***registered_model_name="FlightPriceModel")
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***else:
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mlflow.sklearn.log_model(model,***REMOVED***"model")***REMOVED******REMOVED******REMOVED******REMOVED***